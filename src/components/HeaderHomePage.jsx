  ...
  return (
    <div className="  p-4 justify-between md:flex gap-10 ">
      <div className="flex flex-col mt-[15%] ml-10 gap-2">
        <h1
          className=" text-gray-600 font-bold text-[55px] "
          style={{ fontFamily: "sans-serif" }}
        >
          Travel & Hospitality
        </h1>
        <div className="text-gray-600 text-[22px]">
          Create unforgettable experiences. Anywhere on the globe.
        </div>
        <div className="text-gray-600 text-[18px] font-light">
        ...
        <div className="bg-[#2D9BA8] md:w-[30%] text-white rounded-tl-[80px] rounded-bl-[80px] rounded-br-[80px] py-5 px-[33px]">
          Transform your CX
        </div>
      </div>
